/**
 * Storage Detail Components
 *
 * Barrel export for all storage detail components
 */

// Small reusable components
export { StorageBreadcrumb } from './storage-breadcrumb';
export { ImageGallery } from './image-gallery';
export { CampaignBanner } from './campaign-banner';
export { FacilityGrid } from './facility-grid';
