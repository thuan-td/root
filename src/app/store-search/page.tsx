...
import { SearchBar } from '@/features/store-search/components';
import {
  StoreListWrapper,
  NewStoresWrapper,
  FAQWrapper,
} from '@/features/store-search/components/server';
import { storeSearchData } from '@/features/store-search/data/store-search.data';
